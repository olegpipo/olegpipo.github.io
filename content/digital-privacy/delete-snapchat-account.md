---
title: "Delete Your Snapchat Account (2026)"
description: "How to permanently delete your Snapchat account in 2026. Save your Memories, request your data, and navigate the 30-day deactivation before permanent deletion."
date: 2026-03-08
lastmod: 2026-03-08
draft: false
silo: "Digital Privacy & Online Safety"
faq:
  - q: "How do I permanently delete my Snapchat account?"
    a: "Go to accounts.snapchat.com in a web browser, log in, and click Delete My Account. Enter your password to confirm. Your account will be deactivated for 30 days and then permanently deleted. You cannot delete your account from within the Snapchat app."
  - q: "Can I delete my Snapchat account from the app?"
    a: "No. Snapchat requires you to use the web portal at accounts.snapchat.com to delete your account. The app itself does not have a direct deletion option, though it may link you to the web portal."
  - q: "What happens to my Snapchat Memories when I delete my account?"
    a: "All Memories stored on Snapchat servers are permanently deleted after the 30-day deactivation period. Save your Memories to your camera roll before initiating deletion. You can do this in bulk from the Memories screen in the app."
  - q: "How long does it take to delete a Snapchat account?"
    a: "After you initiate deletion, your account is deactivated for 30 days. During this period you can reactivate by logging in. After 30 days, permanent deletion begins and may take an additional period to fully remove data from all servers."
  - q: "Will my friends know I deleted my Snapchat?"
    a: "Snapchat does not send a notification to your friends when you delete your account. Your name will simply disappear from their friends list and conversations. If they search for you, your account will no longer appear in results."
---

Snapchat pioneered disappearing messages, but the data your account generates does not disappear nearly as easily. Snapchat collects your location data (including Snap Map history), contacts, browsing patterns, and Bitmoji information, building a detailed profile over time. If you have decided to delete your Snapchat account, this guide walks you through the process as part of your [Digital Privacy & Online Safety guide](/digital-privacy/) strategy.
...
| Phase | What Happens |
|-------|-------------|
| **Day 0** | Account deactivated, hidden from friends |
| **Days 1-30** | Account recoverable by logging in |
| **After Day 30** | Permanent deletion, no recovery possible |
...
Check if the email address or phone number linked to your Snapchat account has been involved in any [data breaches](/data-breaches/check-email-compromised/). If so, change the passwords for every affected account. Enable [two-factor authentication](/two-factor-authentication/) wherever it is available, and consider running a complete [personal security audit](/digital-privacy/personal-security-audit/) to make sure your digital life is properly secured.
