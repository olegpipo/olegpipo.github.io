---
title: "Privacy Laws Explained: GDPR, CCPA, DELETE Act"
description: "A plain-language guide to major privacy laws -- GDPR, CCPA, and the DELETE Act -- what they mean for you and how to exercise your rights."
date: 2026-02-14
lastmod: 2026-02-14
draft: false
...
Privacy laws exist to give you control over your personal data, but they only work if you understand them and exercise the rights they provide. As part of your broader [digital privacy and online safety](/digital-privacy/) approach, knowing the legal framework is as important as knowing the technical tools. These laws are your leverage -- the reason companies must provide opt-out mechanisms, honor deletion requests, and disclose what data they collect about you.
...
1. Find the company's Data Protection Officer or privacy contact (usually listed in their privacy policy)
2. Submit a written request specifying which right you are exercising
3. The company must respond within 30 days
4. If the company does not comply, file a complaint with your country's data protection authority
...
1. Look for the "Do Not Sell or Share My Personal Information" link on the company's website
2. Use the company's designated privacy request method (usually found in their privacy policy)
3. The company must respond within 45 days (can be extended by another 45 days with notice)
4. If the company does not comply, file a complaint with the California Attorney General or the California Privacy Protection Agency
...
Before the DELETE Act, [removing your personal information from data brokers](/digital-privacy/remove-personal-info/) was a Sisyphean task. You had to identify each broker, find their opt-out process, submit individual requests, and follow up -- often repeatedly, since brokers re-acquire data. The DELETE Act does not eliminate the need for individual opt-out requests (since not all data brokers may be registered), but it provides a powerful centralized tool.

### How to Use It

1. Visit the California Data Broker Registry website
2. Submit a deletion request (you will need to verify your identity)
3. All registered data brokers must process your deletion within the specified timeframe
4. You can submit a new request periodically to address re-acquired data
...
Before exercising your rights, understand the landscape. Search for yourself online, review what data brokers have on you, and identify companies that hold your personal data. Our guide to [removing your personal information](/digital-privacy/remove-personal-info/) provides a structured process.
...
For services you no longer use, submit deletion requests. Under GDPR and CCPA, companies must delete your data upon request (with limited exceptions). A [personal security audit](/digital-privacy/personal-security-audit/) is a good time to identify accounts to delete.
...
- Use a [password manager](/password-managers/) with unique credentials for every service, so a breach at one service does not expose your credentials elsewhere
...
- [Understanding Data Breaches and Their Impact](/data-breaches/)
