---
title: "Protect Your Accounts During Holiday Shopping"
description: "How to protect your accounts and personal data during holiday shopping season -- phishing scams, fake stores, payment fraud, and more."
date: 2026-02-14
lastmod: 2026-02-14
draft: false
...
For comprehensive phishing defense, see our [phishing protection guide](/phishing/).
...
- **Update passwords** on your most-used retail accounts -- Amazon, Target, Walmart, and any others where you have saved payment information. Use your [password manager](/password-managers/) to generate strong, unique passwords.
- **Enable two-factor authentication** on every retail account that supports it. See our [2FA guide](/two-factor-authentication/).
...
Do your shopping on your [secure home Wi-Fi network](/digital-privacy/secure-home-wifi/) or your cellular data connection. Avoid entering payment information on [public Wi-Fi](/digital-privacy/public-wifi-safety/) -- even with a VPN, the risk is not worth it when you have safer alternatives.
...
1. **Phishing camouflage** -- Attackers send fake marketing emails that blend in with the legitimate flood
2. **Data exposure** -- Every retailer on your email list has your email address and potentially more personal data
...
- Install a password manager and start using unique passwords. For Apple devices, [PanicVault](https://apps.apple.com/app/id6759188575) is a native macOS/iOS app that works with the KeePass KDBX format -- a great choice for anyone in the Apple ecosystem.
...
- Help older relatives recognize [phishing attempts](/phishing/) disguised as shipping notifications
- Set up or review [password managers](/password-managers/) for family members
- Enable two-factor authentication on their retail and financial accounts
- For children who are shopping online, review [online safety basics](/digital-privacy/children-online-safety/)

For seniors in particular, our [cybersecurity for seniors guide](/digital-privacy/cybersecurity-seniors/) covers the specific threats they face.
...
- [Recognizing and Avoiding Phishing](/phishing/)
