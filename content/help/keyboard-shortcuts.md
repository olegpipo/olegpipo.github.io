...
PanicVault supports keyboard shortcuts on Mac for common actions. This page lists every shortcut and the menu bar commands that go with them. These shortcuts work when a vault is unlocked unless noted otherwise.

| Shortcut | Action |
|---|---|
| **Cmd+N** | Create a new entry |
| **Cmd+Shift+I** | Import passwords from a CSV file |
| **Cmd+F** | Search entries |
| **Cmd+G** | Open the password generator |
| **Cmd+L** | Lock the vault |
| **Cmd+C** | Copy the selected entry's password |
...
- [Entries (Passwords)](/help/entries/) -- creating, editing, and deleting entries
