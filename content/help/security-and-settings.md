...
If another device — or another KeePass app — changes the vault's encryption settings, PanicVault re-enables Face ID / Touch ID by itself on the next unlock; a vault protected by a YubiKey needs one unlock with your master password and your key before biometrics work again.
