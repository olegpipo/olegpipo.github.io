...
TOTP authentication removes the carrier from the security equation entirely. Store your TOTP secrets in a trusted password manager -- Apple users can use [PanicVault](https://apps.apple.com/app/id6759188575), a native macOS/iOS app that keeps passwords and TOTP codes together in an encrypted KeePass KDBX vault. Here is why TOTP is immune:
